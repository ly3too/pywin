...
def gettables():
    ...
    ctypes.windll.iphlpapi.GetExtendedTcpTable(NULL, ctypes.byref(dwSize), bOrder, ulAf, TableClass, ctypes.c_ulong)
    ...
    if (ctypes.windll.iphlpapi.GetTcpTable(ctypes.byref(tcpTable),
        ...
        print
        "Error occurred when trying to get TCP Table"
    ...
    if (ctypes.windll.iphlpapi.GetUdpTable(ctypes.byref(udpTable),
        ...
        print
        "Error occurred when trying to get UDP Table"
